...
@section('page-title', 'Login - Max Limited')
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ route('home') }}" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('assets/website/images/maxspeed.png') }}" width="180"
                                        alt="">
                                </a>
                                <p class="text-center">ADMINSTRATIVE LOGIN</p>
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    {{-- <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">New to Max Limited?</p>
