            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <a class="btn btn-lg btn-outline-info mt-2" href="{{ route('packages') }}">
                            Home Package
                        </a>
                        <a class="btn btn-lg btn-info mt-2" href="{{ route('packages.hotspot') }}">
                            Hotspot Package
                        </a>
                    </div>
                </div>
                            ...
                            <div class="card card-shadow on-hover border-0 mb-4">
                                <div class="card-body font-14">
                                    ...
                                    <div class="bottom-btn">
                                        <a class="btn btn-dark btn-md  btn-block" href="#f1"><span>Choose
                                                Plan</span></a>
                                    </div>
                                </div>
                            </div>
